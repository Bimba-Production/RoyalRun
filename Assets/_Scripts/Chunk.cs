...
public class Chunk : MonoBehaviour
{
    ...
    private void InstantiateObjOnLine(GameObject prefab)
    {
        ...
        Vector3 pos = new Vector3(_lanes[_availableLanesIndexes[randIndex]], transform.position.y, transform.position.z);
    ...
    public void SpawnCoin()
    {
        ...
        for (int i = 0; i < coinsToSpawn; i+=1) {
            Vector3 pos = new Vector3(_lanes[_availableLanesIndexes[randIndex]], transform.position.y, (topOfChunkZpos - (i * _coinSeperationLength)));
